...
@Icon(value = Icon.IconType.CUSTOM, custom = "AvalancheExec") // you can use a custom one using @Icon(value=CUSTOM, custom="filename") and adding icons/filename.svg in resources
@PartitionMapper(name = "BulkExec")
@Documentation("TODO fill the documentation for this mapper")
public class AvalancheBulkMapper implements Serializable{
    ...
    public AvalancheBulkMapper(@Option("configuration") final AvalancheBulkMapperConfiguration configuration,
    ...
    @Split
    public List<AvalancheBulkMapper> split(@PartitionSize final long bundles) {
    ...
    @Emitter
    public AvalancheBulkSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new AvalancheBulkSource(configuration, service, recordBuilderFactory, i18nMessage);
    }
}
